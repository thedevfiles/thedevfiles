...
```json Add to the composer.json require section
"doctrine/dbal": "2.3.4"
```
...
```php Setup Class Loader http://docs.doctrine-project.org/projects/doctrine-dbal/en/latest/reference/introduction.html
...
```php Connecting to the database http://docs.doctrine-project.org/projects/doctrine-dbal/en/latest/reference/configuration.html#
...
```php Fetching Data http://docs.doctrine-project.org/projects/doctrine-dbal/en/latest/reference/data-retrieval-and-manipulation.html#fetchall
// Fetch one row
...
```php Prepared Statements http://docs.doctrine-project.org/projects/doctrine-dbal/en/latest/reference/data-retrieval-and-manipulation.html#using-prepared-statements
...
```php Preparing and Executing in one command
...
```php Inserts http://docs.doctrine-project.org/projects/doctrine-dbal/en/latest/reference/data-retrieval-and-manipulation.html#insert
...
```php Updates http://docs.doctrine-project.org/projects/doctrine-dbal/en/latest/reference/data-retrieval-and-manipulation.html#update
$dbh->update('users', array('name' => 'Bob'), array('id' => 1));
// This is the same as running the following query
// UPDATE users SET name = 'Bob' WHERE id = 1
```

```php Deletes http://docs.doctrine-project.org/projects/doctrine-dbal/en/latest/reference/data-retrieval-and-manipulation.html#delete
...
```php Building query with string concatenation and PDO
