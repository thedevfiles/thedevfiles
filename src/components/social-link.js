...
const SocialLinks = () => (
        <div className="widget--about__social">
            ...
            <a target="_blank" rel="noopener noreferrer" href={config.social.googleplus} title="Google Plus">
                <GooglePlusIcon className="icon" style={{height: '1em', width: 'auto', maxWidth: '100%' }} />
            </a>
